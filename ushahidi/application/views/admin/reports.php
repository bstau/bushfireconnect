								...
								foreach ($incidents as $incident)
								{
									...
									<tr>
										...
										<td class="col-4">
											<ul>
												<!--DFP 04/02/2011 -->
												<li class="none-separator"><?php if ($incident_approved) { echo "<a href=# class=\"status_yes\" ?>Approved</a>"; } else { ?> <a href="#" onclick="reportAction('a','APPROVE', '<?php echo $incident_id; ?>');"><?php echo Kohana::lang('ui_main.approve');?></a><?php } ?></li>
												<li><?php if ($incident_verified) echo "<a href=# class=\"status_yes\" ?>Verified</a>"; else { ?> <a href="#" onclick="reportAction('v','VERIFY', '<?php echo $incident_id; ?>');"><?php echo Kohana::lang('ui_main.verify');?></a><?php } ?></li>
