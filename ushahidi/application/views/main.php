						...
						<div id="right" class="clearingfix">
							...
							<ul class="category-filters">
								...
								<?php
									...
									//		echo '<li style="padding-left:20px;"><a href="#" id="cat_'. $child .'"><div class="swatch" style="background-color:#'.$child_color.'"></div><div class="category-title">'.$child_title.$child_image.'</div></a></li>';
											echo '<li style="padding-left:20px;"><a href="#" id="cat_'. $child .'"><img src="media/uploads/'.$child_image.'"> '.$child_title.'</a></li>';
...
new TWTR.Widget({
  version: 2,
  type: 'search',
  search: 'bushfireconnect',
  interval: 6000,
  title: 'Bushfire Connect Rhok',
  subject: 'Bushfire Connect ',
  width: 410,
  height: 150,
  theme: {
    shell: {
