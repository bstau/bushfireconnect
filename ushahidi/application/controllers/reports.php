...
//DFP 04/02/2011 notification

email::send("info@bushfireconnect.org", "info@bushfireconnect.org", "New Incident -".$incident->incident_title, "<p>A new incident was submitted with the next Description:</p>".$incident->incident_description, TRUE);
